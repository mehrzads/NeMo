...
class MemConformerLayer(torch.nn.Module, AdapterModuleMixin, AccessMixin):
    ...
    def __init__(
        ...
        super(MemConformerLayer, self).__init__()
        ...
        self.feed_forward1 = MemConformerFeedForward(d_model=d_model, d_ff=d_ff, dropout=dropout, use_bias=use_bias)

        # convolution module
        self.norm_conv = LayerNorm(d_model)
        self.conv = MemConformerConvolution(
            d_model=d_model,
        ...
        self.feed_forward2 = MemConformerFeedForward(d_model=d_model, d_ff=d_ff, dropout=dropout, use_bias=use_bias)
...
class MemConformerConvolution(nn.Module):
    ...
    def __init__(
        ...
        super(MemConformerConvolution, self).__init__()
...
class MemConformerFeedForward(nn.Module):
    """
    ...
    def __init__(self, d_model, d_ff, dropout, activation=Swish(), use_bias=True):
        super(MemConformerFeedForward, self).__init__()
        self.d_model = d_model
        self.d_ff = d_ff
        self.use_bias = use_bias
